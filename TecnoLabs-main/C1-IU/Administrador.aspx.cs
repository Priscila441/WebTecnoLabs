...
namespace C1_IU
{
    public partial class Administrador : System.Web.UI.Page
    {
		...
		protected void BtnAgregar_Click(object sender, EventArgs e)
		{
			...
			decimal precio;
			if (TxtMarca.Text != "" && TxtModelo.Text != "" && decimal.TryParse(TxtPrecio.Text, out precio) != false && dCategorias.Text != "Seleccionar" && int.TryParse(TxtStock.Text, out stock) != false)
			{
				try
				{
					idCategoria = ObtenerIdCategoria(dCategorias.Text);
		...
		protected Productos ObjetoAuxiliar()
		{
			...
			if (TxtMarca.Text != "" && TxtModelo.Text != "" && decimal.TryParse(TxtPrecio.Text, out precio) != false && dCategorias.Text != "Seleccionar" && int.TryParse(TxtStock.Text, out stock) != false)
			{
				int idCategoria = ObtenerIdCategoria(dCategorias.Text);
				GridViewRow row = gvProductos.SelectedRow;
		...
		protected void BtnAplicarFiltro_Click(object sender, EventArgs e)
		{
			...
			string orden = dropOrden.Text;
			List<Productos> listProductos = conexion.AplicarFiltros(idCategoria, orden);
